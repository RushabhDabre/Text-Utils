    ...
    return (
        <>
            <div className='container' style={{color: props.mode === 'dark' ? 'white' : 'black'}}>
                ...
                <button className={`btn btn-${props.mode} mx-1 my-1`} onClick={handleLoClick}>Convert to Lowercase</button>
                <button className={`btn btn-${props.mode} mx-1 my-1`} onClick={handleClearClick}>Clear the text</button>
                <button className={`btn btn-${props.mode} mx-1 my-1`} onClick={handleCopy}>Copy to clipboard</button>
